...
if __name__ == "__main__":
    grapheme_list = get_graphemes_from_csv('graphemes.csv')
    fieldnames = ['grapheme','num_code_points','names','frequency','code_points','utf8_encodings','length_strings']
    outfile = open('grapheme_encoding_utf8.csv','w',encoding='utf-8-sig',newline='')
    outfile_allchars = open('testchars.csv','w',encoding='utf-8-sig',newline='')
